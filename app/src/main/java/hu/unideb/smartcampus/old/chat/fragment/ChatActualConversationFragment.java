...
public class ChatActualConversationFragment extends Fragment {
                ...
                if (afterViewCreate && isTheFirstListItemVisible && isThereAnyItemOutsideTheListView) {
                    ...
                    if (!(chatHistoryItemCount > chatHistory.getChatConversationItems().size())) {
                        ...
                        try {
                            ...
                            //TODO CONTEXT
                            view.setAdapter(new ChatActualCoversationAdapter(chatHistory, partnerAvatarInBitmap, userAvatarInBitmap, getActivity().getApplicationContext()));
