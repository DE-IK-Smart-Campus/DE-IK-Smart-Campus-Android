...
import hu.unideb.smartcampus.adapter.chat.MucChatActualCoversationAdapter;
...
public class ChatActualConversationMUCFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            e.printStackTrace();
        } catch (SmackException.NoResponseException | XMPPException.XMPPErrorException | InterruptedException | SmackException.NotConnectedException | XmppStringprepException | MultiUserChatException.NotAMucServiceException e) {
            e.printStackTrace();
        }
        ...
        sendButton.setOnClickListener(v -> {
            EditText newMsgText = actualV.findViewById(R.id.chat_text_edit_text);
            ...
            //TODO CONTEXT
            listView.setAdapter(new MucChatActualCoversationAdapter(xmppConnection.getUser(), chatHistory, getActivity().getApplicationContext()));
                ...
                if (afterViewCreate && isTheFirstListItemVisible && isThereAnyItemOutsideTheListView) {
                    ...
                    if (!(chatHistoryItemCount > chatHistory.getChatConversationItems().size())) {
                        ...
                        try {
                            ...
                            //TODO CONTEXT
                            view.setAdapter(new MucChatActualCoversationAdapter(xmppConnection.getUser(), chatHistory, getActivity().getApplicationContext()));
        ...
        listView.setAdapter(new MucChatActualCoversationAdapter(xmppboshConnection.getUser(), chatHistory, getActivity().getApplicationContext()));//TODO CONTEXT
        listView.setSelection(chatHistory.getChatConversationItems().size() - 1);
