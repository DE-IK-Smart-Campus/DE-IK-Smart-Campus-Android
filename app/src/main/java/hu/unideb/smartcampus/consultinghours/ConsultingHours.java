...
public class ConsultingHours extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        teacherList.add(new Teacher("Várterész Magdolna", dateList));
        teacherList.add(new Teacher("Kádek Tamás", dateList));
        teacherList.add(new Teacher("Dr. Horváth Géza", dateList));
        Class mestint = new Class("A mesterséges intelligencia alapjai", teacherList);
        teacherList1.add(new Teacher("Dr. Gál Zoltán", dateList));
        teacherList1.add(new Teacher("Dr. Szilágyi Szabolcs", dateList));
        teacherList1.add(new Teacher("Vas Ádám", dateList));
        Class halo = new Class("Hálózati architektúrák és protokollok", teacherList1);
        teacherList2.add(new Teacher("Dr. Jeszenszky Péter", dateList));
